<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Register.aspx.cs" Inherits="SchoolProject.Register" %>
        ...
        <div class="container">
            ...
            <table style="margin-left: auto; margin-right: auto;">
                <tr>
                    ...
                    <td><asp:TextBox ID="ConfirmPasswordTb" runat="server"></asp:TextBox></td>
                </tr>
                <tr>
            ...
            <asp:Label ID="RegisterInfoLabel" runat="server" Text="" ForeColor="Red"></asp:Label>
        </div>
    </form>
</body>
</html>
